...
**IF THE RESULT IS "D", THAT MEANS THE MATCH IS DRAW* **   
**IF THE RESULT IS "A", THAT MEANS AWAY TEAM WIN THE MATCH **       
**IF THE RESULT IS "W", THAT MEANS HOME TEAM WIN THE MATCH  **      
...
We have standings, but it's not the final. It's just standings for Home and Away team. We have 2 dataframes now, the we have to join them!
